...
#include "Component/KDSynthComponent.h"

bool UKDSynthComponent::Init(int32& SampleRate)
{
	NumChannels = 1;
...
int32 UKDSynthComponent::OnGenerateAudio(float* OutAudio, int32 NumSamples)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
...
void UKDSynthComponent::SetFrequency(const float InFrequencyHz)
{
#if SYNTHCOMPONENT_EX_OSCILATOR_ENABLED
